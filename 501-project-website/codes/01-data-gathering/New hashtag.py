...
climate_df = pd.DataFrame(climate_search, columns=['text', 'author_id', 'created_at', 'en'])
climate_df.head()
#save to csv
climate_df.to_csv('/Users/sangeetha/Documents/anly-501-project-Sangeetha-238/501-project-website/data/New_hashtag.csv', index=False)